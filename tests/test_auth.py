...
class TestAuthModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with app.app_context():
            ...
            # Seed game settings for auth testing.
            # New traders should receive the configured starting capital.
    ...
    def test_register_user_success(self):
        ...
        with app.app_context():
            ...
            self.assertEqual(float(user.cash_balance), 100000.00)
    ...
    def test_register_endpoint_success(self):
        ...
        self.assertEqual(
            response.get_json()["username"],
            "registered_via_api"
        )

        # Verify the newly registered trader received
